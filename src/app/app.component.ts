...
export class AppComponent {
  title = 'creador-notas';
  generalText = 'Para poderte ayudar con tu declaración voy a necesitar la siguiente información: '+
  '\n'
  firstTimeText= ''
  join = false
  medical = ''
  ...
  onClick(){
    ...
    setTimeout(() => {
      ...
      this.generalText = 'Para poderte ayudar con tu declaración voy a necesitar la siguiente información:\n'
      ...
      if(this.form.getRawValue().w2){
        this.generalText = this.generalText + `\n - Tus formas de ingreso por W2 ${this.form.getRawValue().f1099?'y 1099':''}`
      ...
      if(this.form.getRawValue().join){
        ...
        if(this.form.getRawValue().spouseW2){
          this.generalText = this.generalText + `\n - Las formas de ingreso por W2 ${this.form.getRawValue().spouseF1099?'y 1099':''} de tu ${this.spouseOption.value}`
     ...
     /*    '\n           • Nombre Completo'+
      ...
      if(this.form.getRawValue().information){
        ...
        var personal =
        '\n'+
        `\n Datos personales${this.form.getRawValue().join?' tanto tuyos como de tu '+this.spouseOption.value:''}:`+
